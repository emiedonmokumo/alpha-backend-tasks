...
import { CreateCandidateTables1741517000000 } from '../migrations/1741517000000-CreateCandidateTables';
...
export const getTypeOrmOptions = (
  ...
  migrations: [InitialStarterEntities1710000000000, CreateCandidateTables1741517000000],
